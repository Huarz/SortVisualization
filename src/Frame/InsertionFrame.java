            ...
            new SwingWorker<Void, Void>() {
                ...
                protected void done() {
                    ...
                    if (sorting) { // 检查是否是正常完成排序
                        ...
                        JOptionPane.showMessageDialog(InsertionFrame.this, "排序已经完成!", "提示", JOptionPane.INFORMATION_MESSAGE);
                    }
                }
            }.execute();
        }
